...
import com.abhishekmauryaknp.whatsaapclone.databinding.ActivitySignUpBinding;
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(SignUpActivity.this, "Create an account successfully", Toast.LENGTH_SHORT).show();
                                } else {
